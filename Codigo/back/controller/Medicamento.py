...
from model.Medicamento import Medicamento as MedicamentoModel
from model.Pet import Pet as PetModel
from flask_jwt import jwt_required, current_identity

parser = reqparse.RequestParser()
for arg in ['nome', 'dosagem', 'horario', 'estado', 'observacao', 'pet_id']:
...
class Medicamento(Resource):
  ...
  def post(self):
    ...
    try:
      ...
      newMedicamento = MedicamentoModel(args['nome'], args['dosagem'], args['horario'], args['estado'], args['observacao'], args['pet_id'])
      newMedicamento.add()
  ...
  def get(self, pet_id):
    ...
    response = MedicamentoModel.query.getByPetId(pet_id)
